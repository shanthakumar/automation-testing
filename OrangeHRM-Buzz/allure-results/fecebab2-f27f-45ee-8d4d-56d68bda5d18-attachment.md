...
```
Error: locator.click: Error: strict mode violation: getByText('Buzz') resolved to 2 elements:
    1) <span data-v-7b563373="" data-v-6475d26d="" class="oxd-text oxd-text--span oxd-main-menu-item--name">Buzz</span> aka getByRole('link', { name: 'Buzz' })
    2) <p data-v-7b563373="" data-v-133d244a="" class="oxd-text oxd-text--p">Buzz Latest Posts</p> aka getByText('Buzz Latest Posts')

Call log:
  - waiting for getByText('Buzz')
        ...
        - list [ref=e123]:
          - listitem [ref=e124]:
            - generic [ref=e125] [cursor=pointer]:
              ...
              - paragraph [ref=e127]: Krish Patil
              - generic [ref=e128]: 
...
```ts
  ...
  5  |     {
  6  |         this.page = page
  7  |         this.buzzLink = page.getByText('Buzz')
  8  |     }
  9  | 
  10 |     async selectBuzz() {
> 11 |         await this.buzzLink.click()
     |                             ^ Error: locator.click: Error: strict mode violation: getByText('Buzz') resolved to 2 elements:
  12 |     }
  13 | }
```